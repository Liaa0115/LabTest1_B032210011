...
class _BMICalculatorState extends State<BMICalculator> {
  ...
  void initData() async {
    List<Map<String, dynamic>> data = await SQLiteDB().queryAll(bmicalculation.SQLiteTable);
    if (data.isNotEmpty) {
  ...
  void _addbmi() async {
    ...
    if (username.isNotEmpty && weight.isNotEmpty && height.isNotEmpty && gender.isNotEmpty) {
      try {
        ...
        bmicalculation bmicalc = bmicalculation(username, parsedWeightInKg, parsedHeightInCm, gender, bmiStatus);
        await bmicalc.save();
        setState(() {
